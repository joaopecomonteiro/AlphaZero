...
class Board():
    """
    Classe para o tabuleiro do jogo go
    
    Este código foi inspirado num repositório github de alguém que fez uma implementação semelhante ao que estamos a fazer
    Infelizemente, perdemos o link para este repositório e não o conseguimos voltar a encontrar
    """
    ...
    def __init__(self, n):
        ...
        self.liberty_counts = np.zeros((n, n))
        ...
        self.stone_ages = np.zeros((n, n)) - 1
